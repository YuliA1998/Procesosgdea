...
namespace Proceso_168016__sgdetest.Hooks
{
    ...
    public sealed class GeneralHook
    {
        ...
        {
            _extentHtmlReporter = new ExtentHtmlReporter(@"C:\Users\yulia\source\repos\Proceso 168016  sgdetest\DataInformes\log\");
        ...
        public void CreateNode<T>() where T : IGherkinFormatterModel
        {
            ...
            {
                string name = @"C:\Users\yulia\source\repos\Proceso 168016  sgdetest\DataInformes\log\" + _scenarioContext.ScenarioInfo.Title.Replace(" ", "") + ".jpeg";
        ...
        public static void AfterScenario()
        {
            ...
            {
                string name = @"C:\Users\yulia\source\repos\Proceso 168016  sgdetest\DataInformes\log\" + DateTime.UtcNow.ToString("yyyy-MM-dd-mm-ss") + ".jpeg";
                GenericHelper.TakeScreenShot(name);
